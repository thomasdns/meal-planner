  ...
  return (
    ...
    >
      ...
      <LegalSection title="6. Partage des données avec les prestataires">
        ...
        <p>Vercel héberge et déploie l'application, fournit les journaux techniques et le service Vercel Analytics. Vercel est un prestataire américain et peut encadrer les transferts internationaux par ses garanties contractuelles.</p>
